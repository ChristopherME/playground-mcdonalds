...
Check this [branch](https://github.com/ChristopherME/playground-mcdonalds/tree/compose) for Compose implementation and this [PR](https://github.com/ChristopherME/playground-mcdonalds/pull/1/files) for see the refactor process.
